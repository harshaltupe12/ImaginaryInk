  ...
  return (
    <section>
      <div>
          ...
          <p className='mt-2 text-[#666e75] text-[16px] max-w[50px]'>Create imaginative and visually stunning images through ImaginaryINK AI and share them with the community</p>
      </div>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handelSubmit}>
        ...
        <div className="mt-10">
          ...
          <button type='button' className='mt-3 text-white bg-[#6469ff] font-medium rounded-md text-sm sm:w-auto px-5 py-2.5 text-center'>
